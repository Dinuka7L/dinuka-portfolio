...
function ProfessionalQualificationsSection() {
  ...
  return (
    <section id="Certifications" className="py-20 bg-gray-50 dark:bg-gray-800 w-full overflow-hidden">
        ...
        >
          {cards.map((card) => (
              ...
              >
                ...
                <motion.p layoutId={`description-${card.title}-${id}`} className="text-xs text-center text-neutral-500 dark:text-neutral-400">
                  {card.description}
                </motion.p>
                <motion.button
...
const cards = [
  ...
  },
  {
    ...
    src: "https://images.credly.com/size/680x680/images/22a0ece5-ff05-4594-8320-25e55e9ae203/image.png",
    ctaText: "Verify",
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
          The "Postman API Fundamentals Student Expert" certification offered by Postman Academy verifies a student's understanding of APIs, their role in modern development, and how to use Postman to work with them.
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
          Cisco Certified Network Associate(CCNA) Switching, Routing, and Wireless Essentials <br /> <br />
  ...
  {
    description: "Lanka Education And Research Network",
    title: "Network Security",
    src: "https://www.ac.lk/sites/default/files/Learn_Logo.png",
    ctaText: "Verify",
    ctaLink: "https://www.v1.mrview.zedeid.com/verify/did:key:z6MktyAu4G3NrKrrMFxs5rkBDLH99N1QfMa1CGTLcCV4Kk8m/8813",
    content: () => {
      return (
        <p>
